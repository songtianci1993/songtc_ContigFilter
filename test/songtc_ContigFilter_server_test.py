...
from songtc_ContigFilter.songtc_ContigFilterServer import MethodContext


class songtc_ContigFilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('songtc_ContigFilter'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = songtc_ContigFilter(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_songtc_ContigFilter_" + str(suffix)
